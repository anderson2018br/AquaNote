...
class BaseGenusNoteForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'user_avatar_id' => new sfWidgetFormDoctrineSelect(array('model' => 'UserAvatar', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'user_avatar_id' => new sfValidatorDoctrineChoice(array('model' => 'UserAvatar', 'required' => false)),
